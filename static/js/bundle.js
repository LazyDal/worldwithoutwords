...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventsView = __webpack_require__(157);

	var WWWSite = React.createClass({displayName: "WWWSite",
		render: function() {
			return (
				React.createElement(EventsView, null)
			);
		}
	});

	React.render(
	  React.createElement(WWWSite, null),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var EventView = __webpack_require__(159);

	var EventsView = React.createClass({displayName: "EventsView",
		getInitialState: function() {
			return {eventEntries: []};
		},
		componentDidMount: function() {
		...
		render: function() {
			var eventsViews = this.state.eventEntries.map(function(eventEntry) {
				return (React.createElement("div", {className: "eventEntry"}, 
					 				React.createElement(EventView, {data: eventEntry})
								));
			});
			return (React.createElement("div", null, eventsViews));
		}
	});
	...
	var EventView = React.createClass({displayName: "EventView",
		render: function() {
			...
			React.createElement("div", null, 
				React.createElement("img", {className: "eventImage", title: this.props.data.caption, src: imgPath}), 
				React.createElement("div", null, 
					React.createElement("p", null, "Date: ", this.props.data.date, " ")
				)
			)
			);
		}
